...
regardless of Shakapacker version. See the [i18n documentation](./i18n.md)
for an example.
:::
...
See the [i18n documentation](./i18n.md) for more details on configuring the precompile hook.
