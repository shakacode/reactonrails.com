...
**Important:** Both `allWorkersRestartInterval` and `delayBetweenIndividualWorkerRestarts` must be set for restarts to be enabled. See [JS Configuration](../building-features/node-renderer/js-configuration.md) for details.
