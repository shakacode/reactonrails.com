...
The [migration guide](../../migrating/migrating-to-rsc.md) covers how to incrementally adopt RSC in an existing React on Rails application, including:

- [Preparing your app](../../migrating/rsc-preparing-app.md) — infrastructure setup before changing components
- [Component patterns](../../migrating/rsc-component-patterns.md) — restructuring your component tree
- [Context and state management](../../migrating/rsc-context-and-state.md) — handling React Context across the server/client boundary
- [Data fetching](../../migrating/rsc-data-fetching.md) — migrating from client-side to server-side data access
- [Third-party libraries](../../migrating/rsc-third-party-libs.md) — dealing with library compatibility
- [Troubleshooting](../../migrating/rsc-troubleshooting.md) — common issues and solutions
...
- [Streaming Server Rendering](../../building-features/streaming-server-rendering.md) — streaming SSR setup and best practices
- [OSS vs Pro Feature Comparison](../../getting-started/oss-vs-pro.md) — what's included in each tier
