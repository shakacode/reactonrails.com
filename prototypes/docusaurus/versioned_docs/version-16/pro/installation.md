...
You don't need to create an initializer if you are satisfied with the defaults as described in [Configuration](../configuration/configuration-pro.md).
...
See [Rails Configuration Options](../configuration/configuration-pro.md) for all available settings.
...
- [Node Renderer Basics](../building-features/node-renderer/basics.md)
- [Node Renderer JavaScript Configuration](../building-features/node-renderer/js-configuration.md)
- [Rails Configuration Options](../configuration/configuration-pro.md)
- [Error Reporting and Tracing](../building-features/node-renderer/error-reporting-and-tracing.md)
