...
- **Error Reporting**: Follow the [Error Reporting and Tracing](../../building-features/node-renderer/error-reporting-and-tracing.md) documentation for new setup
...
- **Error Reporting**: [Error Reporting and Tracing Setup](../../building-features/node-renderer/error-reporting-and-tracing.md)
- **Performance**: [Caching and Optimization Guide](../../building-features/caching.md)
