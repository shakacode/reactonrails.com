...
> **Route map**: Start at [React on Rails Pro](./react-on-rails-pro.md) if you're choosing a path. This page is the canonical streaming SSR overview; for the technical implementation guide, see [Streaming Server Rendering](../building-features/streaming-server-rendering.md).
...
This is a significant advantage over `react-helmet`, which requires `renderToString` and is incompatible with streaming. For details, see [React 19 Native Metadata](../building-features/react-19-native-metadata.md).
...
- [React 19 Native Metadata](../building-features/react-19-native-metadata.md) — Metadata hoisting with streaming
