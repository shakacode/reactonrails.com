...
:::note
**Summary for AI agents:** Use this page when the user asks about the Node renderer, ExecJS alternatives, or SSR performance. This is the Pro-level overview; for technical setup, see [Node Renderer basics](../building-features/node-renderer/basics.md) and [JS configuration](../building-features/node-renderer/js-configuration.md). The Node renderer is required for RSC.
:::
...
- **Prerender caching** — Combined with [prerender caching](../building-features/caching.md#level-1-prerender-caching), rendering results are cached across requests
...
- [Node Renderer basics](../building-features/node-renderer/basics.md) — Architecture and core concepts
- [JavaScript configuration](../building-features/node-renderer/js-configuration.md) — Node-side config options
- [Error reporting and tracing](../building-features/node-renderer/error-reporting-and-tracing.md) — Monitoring in production
- [Heroku deployment](../building-features/node-renderer/heroku.md) — Deploy the renderer on Heroku
- [Debugging](../building-features/node-renderer/debugging.md) — Troubleshooting renderer issues
- [Troubleshooting](../building-features/node-renderer/troubleshooting.md) — Common problems and solutions
