...
- **Pro-Specific Configurations Moved to Pro Gem**: The following React Server Components (RSC) configurations have been moved from `ReactOnRails.configure` to `ReactOnRailsPro.configure`:
  ...
  **Migration:** If you're using RSC features, move these configurations from your `ReactOnRails.configure` block to `ReactOnRailsPro.configure`:
  ...
  See the [React on Rails Pro Configuration docs](/docs/configuration/configuration-pro) for more details.
...
- **[Pro]** **Error reporting/tracing overhaul**: See [the docs](/docs/building-features/node-renderer/error-reporting-and-tracing). [PR 471](https://github.com/shakacode/react_on_rails_pro/pull/471) by [alexeyr-ci](https://github.com/alexeyr-ci).
...
See [Release Notes](/docs/upgrading/release-notes/16.0.0) for complete migration guide.
